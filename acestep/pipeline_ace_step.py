...
class ACEStepPipeline:
    ...
    def generate_music(
        ...
        the mainly usage only includes the four arguments, leave other arguments as default values.
        
        Args:
            format: audio format, wav, mp3, .etc. Defaults to "wav".
            audio_duration: duration of generated audio in seconds. Defaults to 60.0.
            prompt: text prompt for music generation. Defaults to None.
            lyrics: lyrics for music generation. Defaults to None.
